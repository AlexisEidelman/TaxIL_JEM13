...
\begin{frame}
  ...
  \begin{itemize}
\item Who is rich and who is poor is different at a given time and over life cycle.
\item Who is a contributor and who benefits is also different 
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{Why to be interested in Life-Cycle ?}
  \framesubtitle{\vspace{0.3cm} Redistribution} \pause
  \begin{itemize}
\item 
\item  
 \begin{enumerate}
...
\includegraphics[0.1]{struggling_with_Python.jpg}
\end{frame}
