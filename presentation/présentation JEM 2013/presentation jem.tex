...
\author{Béatrice Boutchenik et Alexis Eidelman}
\institute{\emph{Institut des politiques publiques}}
\subject{Redistribution ; micro-simulation ; cycle de vie}
...
\begin{frame}
  ...
  \framesubtitle{\vspace{0.3cm}Présentation générale du modèle TAXIPP-LIFE}
  \begin{itemize}
    \item Modèle de micro-simulation développé par l'\textit{Institut des politiques publiques} (IPP)
  \item Complète le modèle TAXIPP \pause
  \item \textbf{Travail en cours} \pause
...
\begin{frame}
  ...
  \begin{enumerate}
    \item L'enjeu de la perspective de cycle de vie
    \item Base de données rétrospectives et résultats préliminaires
    \item Simulation sur le cycle de vie
    \item Conclusion et développements
  \end{enumerate}
\end{frame}
...
\begin{frame}
  ...
  \framesubtitle{\vspace{0.3cm}Importance pour l'étude des inégalités} \pause
  \begin{itemize}
\item \textbf{Variabilité des revenus sur le cycle de vie}
 \begin{enumerate}
